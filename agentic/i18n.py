...
STR = {
    "en": {
        ...
        "col_task": "Task", "col_tools": "Tools", "col_thinking": "Think", "col_active": "Active",
        "think_unsupported_note": "  {model} rejected the thinking setting — continuing without it.",
    ...
    "fr": {
        ...
        "col_task": "Tâche", "col_tools": "Tools", "col_thinking": "Réflex.", "col_active": "Actif",
        "think_unsupported_note": "  {model} a refusé le réglage de réflexion — on continue sans.",

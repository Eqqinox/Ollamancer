...
| Model | Size | tools | In? |
|---|---|---|---|
| `oamazonasgabriel/qwen2.5-coder.1.5b-mlx:f16-8gbGPU` | 3.1 GB | ✅ | yes |
| `htunnthuthutech/gemma-4-e2b-aiops` | 3.4 GB | ✅ | yes |
| `qwen3.5:4b` | 3.4 GB | ✅ | yes |
| `gamy316/aileen1.0` | 4.9 GB | ✅ | yes |
| `lfm2.5:8b` | 5.2 GB | ✅ | yes |
| `MHKetbi/DeepSeek-R1-Distill-Llama-8B-NexaQuant` | 5.3 GB | ✅ | yes |
| `ornith:9b` | 5.6 GB | ✅ | yes |
| `hf.co/deepreinforce-ai/Ornith-1.0-9B-GGUF:Q4_K_M` | 5.6 GB | ✅ | yes |
| `studiobrn/modCoderMLX` | 7.4 GB | ✅ | yes |
| `jikepjikep_16HEX/gemma-4-12b-nightshift-heretic…` | 7.4 GB | ✅ | yes |
| `gemma4:12b-mlx` | 7.7 GB | ✅ | yes |
| `gpt-oss:20b` | 13.8 GB | ✅ | yes |
| `gemma4:26b-mlx` | 17.6 GB | ✅ | yes |
| `Agen/gemma-4-26B-A4B-it-uncensored-heretic` | 18.0 GB | ✅ | yes |
| `qwen3-coder:30b` | 18.6 GB | ✅ | yes |
| `rafw007/Qwen3.6-35B-A3B-mlx-claude-coder-abliterated` | 23.9 GB | ✅ | yes (heavy) |
| `charaf/Qwen3.6-27B-OBLITERATED-mlx-q8` | 28.6 GB | ✅ | yes (heavy) |
| `translategemma:27b` | 17.4 GB | ❌ **no tools** | **excluded** |
...
candidates and several untested newcomers, this is where most of the saving comes
from. *≈25–35 min.*
